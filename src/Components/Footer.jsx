...
import me1 from "../Images/meExpanded-transformed (1).jpeg";
...
function Footer(){
    ...
    return(
    	...
    	<div class="col pb-0 pe-5 pt-5 ps-5" style={{height:"fit-content",zIndex:"5"}}>
			...
			Sellami Mohammed Abdelhadi | Programmer & IT Specialist
Unlock the potential of your data with AI & web development. Let's turn your vision into reality.
    		</div>
    	...
    	<div class="col p-5" style={{height:"fit-content",zIndex:"5"}}>
			<div class="d-flex flex-row pt-3 justify-content-end" style={{gap:"25px",zIndex:"5"}}>
				<IconButton href="https://www.linkedin.com/in/mohammed-abdelhadi-sellami-241880209/" className="iconbutton" color="primary" aria-label="LinkedIn" style={{color:"var(--white)"}}>
					<LinkedIn fontSize={"large"} />
				</IconButton>
				<IconButton href="https://www.facebook.com/profile.php?id=100012502147526"  className="iconbutton"  color="primary" aria-label="Facebook" style={{color:"var(--white)"}}>
					<Facebook fontSize={"large"} />
				</IconButton>
				<IconButton href="https://twitter.com/XxHUNTERx5" className="iconbutton"  color="primary" aria-label="Twitter" style={{color:"var(--white)"}}> 
					<Twitter fontSize={"large"} />
				</IconButton>
				<IconButton href="https://github.com/hunter123520"  className="iconbutton"  color="primary" aria-label="Github"style={{color:"var(--white)"}} >
					<GitHub fontSize={"large"} />
				</IconButton>
			</div>
			<div class="d-flex flex-row pt-3 justify-content-end" style={{gap:"25px",zIndex:"5"}}>
				<a className='but' href='mailto: philippe.fernandez.2002@gmail.com'>philippe.fernandez.2002@gmail.com</a>
			</div>
    	</div>
  	</div>
  	...
  	<div class="row justify-content-md-center pb-2"> 
		  ...
		  Copyright © 2024 Sellami Mohammed Abdelhadi All rights reserved.
  		</div>
  	</div>
